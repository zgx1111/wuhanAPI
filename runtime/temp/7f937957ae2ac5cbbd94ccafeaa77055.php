<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"/www/server/apache/htdocs/api/public/../application/admin/view/storehouse/artUpdate.html";i:1579245297;s:84:"/www/server/apache/htdocs/api/public/../application/admin/view/storehouse/_meta.html";i:1571821518;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    function getOne(){
        var params={
            ...
            sCallback:function(res) {
                ...
                $('#like_num').val(res.like_num);
                $('#read_num').val(res.read_num);
                $('#status').val(res.status);
                 str='<li><img src="'+res.img_url+'"></li>';
                $('.main').children('.list').html(str);
