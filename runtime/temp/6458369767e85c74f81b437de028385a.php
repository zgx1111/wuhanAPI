<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/server/apache/htdocs/api/public/../application/admin/view/store/productAll.html";i:1576814457;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function getProducts(page){
        ...
        //alert(token);
        var params={
            url:'/product/getproductsByStoreID',
            data:{'page':page},
            tokenFlag:true,
            type:'post',
    ...
    function getCount(nowPage){
        var params={
            url:'/product/getProductCountByStoreID',
            data:{},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
