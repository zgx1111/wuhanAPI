<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/server/apache/htdocs/api/public/../application/admin/view/store/info.html";i:1575807956;s:79:"/www/server/apache/htdocs/api/public/../application/admin/view/store/_meta.html";i:1571821518;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 个人信息 <span class="c-gray en">&gt;</span> 查看信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <form action="javascript:;" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text" readonly id="username" name="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">店名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" readonly id="truename" name="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">所属供货仓：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="" id="storehouse" readonly class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">所属推广员：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" readonly id="eworker" name="">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    if(!window.base.getLocalStorage('storeToken')){
        window.location.href = '/yxstore';
    }
    //获得id的商品详情
    getinfo();
    function getinfo(){
        var params={
            ...
            sCallback:function(res) {
                ...
                $('#storehouse').val(res.storehouse.truename);
                $('#eworker').val(res.eworker.truename);
            },
            eCallback:function(res){
                alert('获得失败');
            }
        };
        window.base.getStoreData(params);
    }
</script>
</body>
</html>