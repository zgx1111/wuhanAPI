<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"/www/server/apache/htdocs/api/public/../application/admin/view/store/index.html";i:1576035568;s:80:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_meta.html";i:1571404302;s:81:"/www/server/apache/htdocs/api/public/../application/admin/view/store/_header.html";i:1575806798;s:79:"/www/server/apache/htdocs/api/public/../application/admin/view/store/_menu.html";i:1575807921;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl>
			...
			<dd>
				<ul>
					<li><a data-href="/store/productAll" data-title="查看商品" href="javascript:void(0)">查看商品</a></li>
				</ul>
			</dd>
		</dl>
		<dl>
			<dt><i class="Hui-iconfont">&#xe616;</i> 门店信息<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="/store/info" data-title="查看信息" href="javascript:void(0)">查看信息</a></li>
				</ul>
			</dd>
		</dl>
		<dl>
			...
			<dd>
				<ul>
					<li><a data-href="/store/payOrder" data-title="已完成订单" href="javascript:void(0)">已完成订单</a></li>
				</ul>
			</dd>
		</dl>
...
<script type="text/javascript">
    ...
    $('.out').click(function(){
        layer.alert("退出");
        window.base.deleteLocalStorage('storeToken');
