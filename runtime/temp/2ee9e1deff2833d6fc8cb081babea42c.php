<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/adminUpdateStorehouse.html";i:1575620526;s:79:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/_meta.html";i:1571821518;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 供货仓 <span class="c-gray en">&gt;</span> 修改供货仓 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <form action="javascript:;" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="账号" id="username">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="密码" id="password" name="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">名字：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="供货仓名字" id="truename" name="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">管理者：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="管理者" id="adminname" name="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">电话：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="电话" id="phone" name="">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    function getOne(){
        var params={
            url:'/storehouse/adminGetStorehouseOne',
            data:{'id':id},
            type:"post",
            tokenFlag:true,
    ...
    $('.sub').click(function(){
        var params={
            url:'/storehouse/adminUpdateStorehouse',
            data:{
                'id':id,
