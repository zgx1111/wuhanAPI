<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/adminGetStorehouseOrder.html";i:1575620526;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 供货仓管理 <span class="c-gray en">&gt;</span> 查看供货仓订单 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
    ...
    function getOrders(page){
        ...
        //alert(token);
        var params={
            url:'/order/adminGetStorehouseOrder',
            data:{'id':id,'page':page,'year':year,'month':month,'status':3},
            tokenFlag:true,
            type:'post',
    ...
    //获得订单总数
    function getCount(nowPage,year,month){
        var params={
            url:'/order/adminGetStorehouseOrderCount',
            data:{'id':id,'year':year,'month':month,'status':3},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
                //alert(res);
