<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/server/apache/htdocs/api/public/../application/admin/view/storehouse/productNo.html";i:1576488759;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 商品管理 <span class="c-gray en">&gt;</span> 售罄商品 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"><font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;售馨商品</font></div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    function getProducts(page){
        ...
        //alert(token);
        var params={
            url:'/product/storehouseGetProductNo',
            data:{'page':page},
            tokenFlag:true,
            type:'post',
            ...
            if(len>0) {
                for (var i = 0; i < len; i++) {
                    ...
                    str += '<tr class="text-c">' +
                            ...
                            '<td><button class="btn btn-primary" onclick="upload(' + item.id +')">上传详细图片</button></td>' +
                            '<td><button class="btn btn-info" onclick="update(' + item.id +')">编辑</button></td>' +
    ...
    function getCount(nowPage){
        var params={
            url:'/product/storehousegetProNoCount',
            data:{},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
