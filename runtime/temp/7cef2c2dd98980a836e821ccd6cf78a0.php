<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/storehouseOrder.html";i:1575620526;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="text-c city"> 城市：
        <select name="city" class="select" id="city" onchange="getStorehouse()">
        </select>
        供货仓：
        <select name="city" class="select" id="storehouse">
...
<script type="text/javascript">
    ...
    function getOrders(page){
        var year = $("#year").val();
        var month = $("#month").val();
        var storehouseID = $("#storehouse").val();
        ...
        var params={
            ...
            data:{'id':storehouseID,'page':page,'year':year,'month':month,'status':status},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
                ...
                if(res){
                    ...
                    $('tbody').html(str);
                    getCount(page,year,month,storehouseID,status);
                }
            },
    ...
    //获得订单总数
    function getCount(nowPage,year,month,storehouseID,status){
        var params={
            url:'/order/adminGetStorehouseOrderCount',
            data:{'id':storehouseID,'status':status,'year':year,'month':month},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
                if(res.amount){
    ...
    function getStorehouse(){
        ...
        var cityID = $("#city").val();
        var params={
            url:'/storehouse/adminGetStorehouseByCityID',
            data:{"cityID":cityID},
            type:'post',
            tokenFlag:true,
            sCallback:function(res) {
