<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/server/apache/htdocs/api/public/../application/admin/view/storehouse/productHot.html";i:1575621929;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 商品管理 <span class="c-gray en">&gt;</span> 热销商品 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"><font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;热销商品</font></div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    function getProducts(page){
       ...
       // alert(token);
        var params={
            url:'/product/storehouseGetProductHot',
            data:{'k':1},
            tokenFlag:true,
            type:'post',
