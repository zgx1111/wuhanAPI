<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/storeOrder.html";i:1575620526;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="text-c city"> 城市：
        <select name="city" class="select" id="city" onchange="getStore()">
        </select>
        门店：
        <select name="city" class="select" id="store">
...
<script type="text/javascript">
    ...
    function getOrders(page){
        ...
        //alert(token);
        var params={
            url:'/order/GetStoreOrder',
            data:{'id':storeID,'page':page,'year':year,'month':month,'status':status},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
                ...
                if(res){
                    ...
                    $('tbody').html(str);
                    getCount(page,year,month,storeID,status);
                }
            },
    ...
    //获得订单总数
    function getCount(nowPage,year,month,storeID,status){
        var params={
            url:'/order/GetStoreOrderCount',
            data:{'id':storeID,'status':status,'year':year,'month':month},
            tokenFlag:true,
            type:'post',
            sCallback:function(res) {
                if(res.amount){
    ...
    function getStore(){
        ...
        var cityID = $("#city").val();
        var params={
            url:'/store/adminGetStoreByCityID',
            data:{"id":cityID},
            type:'post',
            tokenFlag:true,
            sCallback:function(res) {
