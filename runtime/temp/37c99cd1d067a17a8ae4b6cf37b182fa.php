<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/payOrder.html";i:1575807731;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
        ...
        //alert(token);
            var params={
                ...
                sCallback:function(res) {
                    //拼接字符串
                    if(res){
                        var str = getAllOrderHtmlStr(res);
                        $('tbody').html(str);
                        getAllCount(page,year,month);
                    }
                },
    ...
    //拼接字符串
    function getAllOrderHtmlStr(res){
        var data = res;
        if (data){
    ...
    //分页
    function setAllPage(count,nowPage){
    ...
    //获得订单总数
    function getAllCount(nowPage,year,month){
        var params={
            url:'/order/adminGetOrderCount',
