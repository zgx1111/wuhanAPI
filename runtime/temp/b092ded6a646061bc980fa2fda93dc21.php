<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/server/apache/htdocs/api/public/../application/admin/view/login/store.html";i:1575620687;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        var params = {
            ...
            sCallback: function (res) {
                    if(!res.token){
                        ...
                        //缓存token
                        window.base.setLocalStorage('storeToken', res.token);
