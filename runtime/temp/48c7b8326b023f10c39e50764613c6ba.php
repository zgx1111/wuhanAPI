<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/www/server/apache/htdocs/api/public/../application/admin/view/login/eworker.html";i:1575620526;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        var params = {
            ...
            sCallback: function (res) {
                if(!res.token){
                    ...
                    //缓存token
                    window.base.setLocalStorage('eworkerToken', res.token);
                    layer.msg('登陆成功',{icon:1,time:1000});
                    window.location.href = 'eworker/index';
                }
            },
