<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/server/apache/htdocs/api/public/../application/admin/view/storehouse/articleAll.html";i:1578292976;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
        ...
        var params={
            ...
            sCallback:function(res) {
                if(!res.status){
                    ...
                    //拼接字符串
                    var str = getOrderHtmlStr(res.art);
                    $('tbody').html(str);
                    getCount(page);
                }
            },
            ...
            if(len>0) {
                for (var i = 0; i < len; i++) {
                    ...
                    str += '<tr class="text-c">' +
                            ...
                            '<td width="80"><button class="btn btn-success" onclick="update(' + item.id +')">编辑</button></td>' +
                            '<td width="80"><button class="btn btn-danger" onclick="del(this,' + item.id +')">删除</button></td>' +
                            '</tr>';
                }
            }
            return str;
    ...
    function update(id){
        //alert(id);
        window.location.href = 'artUpdate?id='+id;
    }
    //删除
    function del(obj,id){
