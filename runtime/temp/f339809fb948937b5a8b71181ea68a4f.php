<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/server/apache/htdocs/api/public/../application/admin/view/admin/getCityAll.html";i:1575620526;s:82:"/www/server/apache/htdocs/api/public/../application/admin/view/public/_footer.html";i:1571402714;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>城市 <span class="c-gray en">&gt;</span>查看城市 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
            ...
            if(len>0) {
                for (var i = 0; i < len; i++) {
                    ...
                    str += '<tr class="text-c">' +
                        ...
                        '<td width="100px"><button class="btn btn-warning" onclick="delCity('+item.id+')">删除</button></td>' +
                        '</tr>';
                }
            }
            return str;
    ...
    function delCity(id){
        alert(id);
        layer.confirm('是否确认删除id为'+id+'的城市，注意该城市是否有门店供货仓', ['确定','取消'], function(){
            var params={
                url:'/city/adminDelCity',
                data:{'id':id},
                tokenFlag:true,
                type:'post',
                sCallback:function(res) {
